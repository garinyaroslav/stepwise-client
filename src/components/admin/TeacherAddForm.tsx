    ...
    const onSubmit = async (data: z.infer<typeof userRegister>) => {
        try {
            ...
            if (error.response?.status === HttpStatusCode.Conflict) {
                toast.error("Преподаватель с таким именем пользователя или электронной почтой уже существует.");
            } else {
                toast.error("Произошла ошибка при создании преподавателя.");
            }
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input
                                        placeholder="Введите имя пользователя преподавателя"
                                        {...field}
                                    />
                                </FormControl>
                                <FormDescription>
                                    Это имя, которое преподаватель будет использовать для входа в
                                    систему.
                                </FormDescription>
                                <FormMessage />
                            </FormItem>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input
                                        placeholder="Введите электронную почту преподавателя"
                                        type="email"
                                        {...field}
                                    />
                                </FormControl>
                            ...
                            <FormItem className="flex-1">
                                ...
                                <FormControl>
                                    <div className="flex gap-2">
                                        <PasswordInput
                                            placeholder="Введите пароль, который будет использовать преподаватель для входа в систему"
                                            {...field}
                                        />
